...
const NotaPrintTemplate = forwardRef(function NotaPrintTemplate({ sekolah, data }, ref) {
  ...
  return (
    <div
      ref={ref}
      className="print-only relative bg-white text-black"
      style={{
        width: '210mm',
    ...
    >
      {/* Spacer kosong 148mm — mendorong seluruh konten Nota ke separuh BAWAH
          kertas A4, supaya tidak tumpang tindih dengan Kuitansi yang mengisi
          separuh atas kertas yang sama saat dicetak ulang (dua kali jalan). */}
      <div style={{ height: '148mm' }} aria-hidden="true" />

      <div className="p-6 text-xs" style={{ minHeight: '148mm' }}>
