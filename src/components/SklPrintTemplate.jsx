...
const SklPrintTemplate = React.forwardRef(function SklPrintTemplate(
  ...
  return (
    <div
      ...
      style={{
        // PERBAIKAN: kontainer dijadikan flex column dengan tinggi PASTI
        // (height, bukan minHeight) satu lembar A4. Sebelumnya pakai
        // `minHeight: 297mm`, sehingga tinggi kertas hanya jadi batas
        // bawah — kalau isi suratnya sedikit, div ini menyusut mengikuti
        // konten dan tanda tangan (yang cuma diberi marginTop 30px)
        // otomatis nempel tepat di bawah paragraf penutup, bukan di dasar
        // kertas. Dengan height pasti + display:flex column, sisa ruang
        // kosong di bawah konten bisa dipakai untuk mendorong blok tanda
        // tangan ke bawah lewat marginTop:"auto" di blok itu.
        display: "flex",
    ...
    >
      ...
      {/* PERBAIKAN: marginTop:"auto" memakai sisa ruang kosong flex-column
          untuk mendorong blok ini ke dasar kertas, apa pun panjang konten
          di atasnya. pageBreakInside "avoid" tetap dipertahankan supaya
          blok ini tidak pernah terpotong kalau suatu saat kontennya
