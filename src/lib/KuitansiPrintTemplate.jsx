 ...
 *
 * Catatan posisi cetak:
 *  - Padding atas sengaja dibuat 0 (pt-0) supaya seluruh isi mepet ke ujung
 *    kertas paling atas. Padding kiri/kanan/bawah tetap dipertahankan.
 *  - Jika masih ada jarak dari tepi kertas, cek juga aturan `@page { margin }`
 *    di file CSS print global project (biasanya index.css / App.css) —
 *    margin halaman itu di luar kendali komponen ini.
 */
const KuitansiPrintTemplate = forwardRef(function KuitansiPrintTemplate({ sekolah, data, items = [] }, ref) {
  ...
  return (
    <div
      ref={ref}
      className="print-only bg-white text-black pt-0 pb-10 px-10 text-sm"
