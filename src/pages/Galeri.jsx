...
export default function Galeri() {
  const { profil, isAdmin, isSuperAdmin, sekolahId } = useAuth()
  ...
  async function load() {
    ...
    // Setiap sekolah cuma boleh lihat galeri miliknya sendiri — superadmin
    // (tidak terikat sekolah_id) tetap bisa lihat semua sekolah.
    if (!isSuperAdmin) {
