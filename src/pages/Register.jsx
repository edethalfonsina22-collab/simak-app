...
export default function Register() {
  ...
  async function handleSubmit(event) {
    ...
    // Jangan biarkan user baru langsung masuk sebelum disetujui admin.
    if (data?.session) {
  ...
  return (
    <main className="flex min-h-screen items-center justify-center bg-slate-950 px-4 py-8">
      <section className="w-full max-w-md rounded-2xl border border-slate-700 bg-slate-900 p-6 text-white shadow-2xl">
        ...
        <div className="mb-6">
          <div className="mb-4 flex h-12 w-12 items-center justify-center rounded-xl bg-emerald-400 font-bold text-slate-950">
            <UserPlus size={22} />
          </div>
