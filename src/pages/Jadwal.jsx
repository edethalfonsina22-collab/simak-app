...
export default function Jadwal() {
  ...
  return (
    <Layout title="Jadwal Pelajaran" subtitle="Susunan jam mengajar per kelas" actions={
      <button className="inline-flex items-center gap-2 px-4 py-2 rounded-lg text-sm font-medium bg-[#6b0f1a] text-white hover:bg-[#7d1420] transition-colors shadow-sm shadow-[#6b0f1a]/30" onClick={() => setShowForm(true)}><Plus size={16} /> Tambah Jadwal</button>
    }>
